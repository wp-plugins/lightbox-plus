 ...
 * @version    2.7
 * @$Id: lightbox.secondary.php 937943 2014-06-24 17:06:54Z dzappone $
 * @$URL: http://plugins.svn.wordpress.org/lightbox-plus/trunk/admin/lightbox.secondary.php $
 */

$g_lbp_secondary_options = $this->getAdminOptions( $this->lightboxOptionsSecondaryName );
...
<div id="slbp-tabs-1">
	...
	<table class="form-table">
		...
		<tr>
			...
			<td>
				<input type="checkbox" name="preloading_sec" value="1"<?php checked( '1', $g_lbp_secondary_options['preloading_sec'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
...
<div id="slbp-tabs-2">
	<table class="form-table">
		<tr>
			...
			<td>
				<input type="text" size="15" name="width_sec" id="width_sec" value="<?php if ( ! empty( $g_lbp_secondary_options['width_sec'] ) ) {
		...
		<tr>
			...
			<td>
				<input type="text" size="15" name="height_sec" id="height_sec" value="<?php if ( ! empty( $g_lbp_secondary_options['height_sec'] ) ) {
		...
		<tr>
			...
			<td>
				<input type="text" size="15" name="inner_width_sec" id="inner_width_sec" value="<?php if ( ! empty( $g_lbp_secondary_options['inner_width_sec'] ) ) {
		...
		<tr>
			...
			<td>
				<input type="text" size="15" name="inner_height_sec" id="inner_height_sec" value="<?php if ( ! empty( $g_lbp_secondary_options['inner_height_sec'] ) ) {
		...
		<tr>
			...
			<td>
				<input type="text" size="15" name="initial_width_sec" id="initial_width_sec" value="<?php if ( ! empty( $g_lbp_secondary_options['initial_width_sec'] ) ) {
		...
		<tr>
			...
			<td>
				<input type="text" size="15" name="initial_height_sec" id="initial_height_sec" value="<?php if ( ! empty( $g_lbp_secondary_options['initial_height_sec'] ) ) {
		...
		<tr>
			...
			<td>
				<input type="text" size="15" name="max_width_sec" id="max_width_sec" value="<?php if ( ! empty( $g_lbp_secondary_options['max_width_sec'] ) ) {
		...
		<tr>
			...
			<td>
				<input type="text" size="15" name="max_height_sec" id="max_height_sec" value="<?php if ( ! empty( $g_lbp_secondary_options['max_height_sec'] ) ) {
		...
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="resize_sec" id="resize_sec" value="1"<?php checked( '1', $g_lbp_secondary_options['resize_sec'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
...
<div id="slbp-tabs-3">
	<table class="form-table">
		<tr>
			...
			<td>
				<input name="top_sec" type="text" id="top_sec" size="8" maxlength="8" value="<?php if ( ! empty( $g_lbp_secondary_options['top'] ) ) {
		...
		<tr>
			...
			<td>
				<input name="right_sec" type="text" id="right_sec" size="8" maxlength="8" value="<?php if ( ! empty( $g_lbp_secondary_options['right'] ) ) {
		...
		<tr>
			...
			<td>
				<input name="bottom_sec" type="text" id="bottom_sec" size="8" maxlength="8" value="<?php if ( ! empty( $g_lbp_secondary_options['bottom'] ) ) {
		...
		<tr>
			...
			<td>
				<input name="left_sec" type="text" id="left_sec" size="8" maxlength="8" value="<?php if ( ! empty( $g_lbp_secondary_options['left'] ) ) {
		...
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="fixed_sec" id="fixed_sec" value="1"<?php if ( isset( $g_lbp_secondary_options['fixed'] ) ) {
...
<div id="slbp-tabs-4">
	<table class="form-table">
		...
		<tr class="grouping_sec">
			...
			<td>
				<input type="text" size="15" name="close_sec" id="close_sec" value="<?php if ( empty( $g_lbp_secondary_options['close_sec'] ) ) {
					echo '';
				} else {
		...
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="overlay_close_sec" id="overlay_close_sec" value="1"<?php checked( '1', $g_lbp_secondary_options['overlay_close_sec'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="esc_key_sec" id="esc_key_sec" value="1"<?php checked( '1', $g_lbp_secondary_options['esc_key_sec'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="scrolling_sec" id="scrolling_sec" value="1"<?php checked( '1', $g_lbp_secondary_options['scrolling_sec'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			...
			<td>
				...
				<input type="checkbox" id="rel_sec" name="rel_sec" value="nofollow"<?php if ( $g_lbp_secondary_options['rel_sec'] == 'nofollow' ) {
		...
		<tr class="grouping_sec">
			...
			<td>
				<input type="text" size="15" name="label_image_sec" id="label_imag_sece" value="<?php if ( empty( $g_lbp_secondary_options['label_image_sec'] ) ) {
					echo '';
				} else {
					echo $g_lbp_secondary_options['label_image_sec'];
				} ?>" />
				#
				<input type="text" size="15" name="label_of_sec" id="label_of_sec" value="<?php if ( empty( $g_lbp_secondary_options['label_of_sec'] ) ) {
					echo '';
				} else {
		...
		<tr class="grouping_sec">
			...
			<td>
				<input type="text" size="15" name="previous_sec" id="previous_sec" value="<?php if ( empty( $g_lbp_secondary_options['previous_sec'] ) ) {
					echo '';
				} else {
		...
		<tr class="grouping_sec">
			...
			<td>
				<input type="text" size="15" name="next_sec" id="next_sec" value="<?php if ( empty( $g_lbp_secondary_options['next_sec'] ) ) {
					echo '';
				} else {
		...
		<tr class="grouping_sec">
			...
			<td>
				...
				<input type="checkbox" name="arrow_key_sec" id="arrow_key_sec" value="1"<?php checked( '1', $g_lbp_secondary_options['arrow_key_sec'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr class="grouping_sec">
			...
			<td>
				...
				<input type="checkbox" name="loop_sec" id="loop_sec" value="1"<?php checked( '1', $g_lbp_secondary_options['loop_sec'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="slideshow_sec" id="slideshow_sec" value="1"<?php if ( isset( $g_lbp_secondary_options['slideshow_auto'] ) ) {
		...
		<tr class="slideshow_sec">
			...
			<td>
				...
				<input type="checkbox" name="slideshow_auto_sec" id="slideshow_auto_sec" value="1"<?php if ( isset( $g_lbp_secondary_options['slideshow_auto'] ) ) {
		...
		<tr class="slideshow_sec">
			...
			<td>
				<input type="text" size="15" name="slideshow_start_sec" id="slideshow_start_sec" value="<?php if ( ! empty( $g_lbp_secondary_options['slideshow_start_sec'] ) ) {
		...
		<tr class="slideshow_sec">
			...
			<td>
				<input type="text" size="15" name="slideshow_stop_sec" id="slideshow_stop_sec" value="<?php if ( ! empty( $g_lbp_secondary_options['slideshow_stop_sec'] ) ) {
	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="photo_sec" id="photo_sec" value="1"<?php checked( '1', $g_lbp_secondary_options['photo_sec'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			<th scope="row">
				<?php _e( 'Use iFrame', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="iframe_sec" value="0" />
				<input type="checkbox" name="iframe_sec" id="iframe_sec" value="1"<?php checked( '1', $g_lbp_secondary_options['iframe_sec'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			<th scope="row">
				<?php _e( 'Secondary Class Name', 'lightboxplus' ) ?>:
			</th>
			<td>
				<!-- input type="checkbox" name="use_class_method_sec" id="use_class_method_sec" value="1"<?php // checked('1', $lightboxPlusSecondaryOptions['use_class_method_sec']);?> / -->
				<!-- Class name: -->
				<input type="text" size="15" name="class_name_sec" id="class_name_sec" value="<?php if ( empty( $g_lbp_secondary_options['class_name_sec'] ) ) {
					echo 'lbpModal';
				} else {
		...
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="no_display_title_sec" id="no_display_title_sec" value="1"<?php checked( '1', $g_lbp_secondary_options['no_display_title_sec'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
	...
	<table class="form-table">
		...
		<tr>
			<td>
				...
				<p>
					<a title="Lightbox Plus Colorbox Forums" href="http://wordpress.org/support/plugin/lightbox-plus"<?php
					if ( isset( $g_lbp_secondary_options['class_name_sec'] ) ) {
						echo ' class="' . $g_lbp_secondary_options['class_name_sec'] . '"';
					}
					if ( isset( $g_lbp_secondary_options['output_htmlv'] ) ) {
				...
				<p><a href="<?php echo LBP_ASSETS_URL ?>/exmaples/trivia.swf"<?php
					if ( isset( $g_lbp_secondary_options['class_name_sec'] ) ) {
						echo ' class="' . $g_lbp_secondary_options['class_name_sec'] . '"';
					}
					if ( isset( $g_lbp_secondary_options['output_htmlv'] ) ) {

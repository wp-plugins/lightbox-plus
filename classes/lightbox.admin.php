 ...
 * @version    2.7
 * @$Id: lightbox.admin.php 937943 2014-06-24 17:06:54Z dzappone $
 * @$URL: http://plugins.svn.wordpress.org/lightbox-plus/trunk/admin/lightbox.admin.php $
 */
/**
 * TODO: ? change this to direct statement or leave as is ?
 */
$g_lbp_options = $this->getAdminOptions( $this->lightboxOptionsName );
$g_lbp_primary_options = $this->getAdminOptions( $this->lightboxOptionsPrimaryName );
 ...
 * @var mixed
 */
if ( $g_lbp_options['use_custom_style'] == 1 ) {
	$stylePath = LBP_CUSTOM_STYLE_PATH;
} else {
	$stylePath = LBP_STYLE_PATH;
}
 ...
 */
if (isset($g_lbp_options)) { $g_lbp_options = $this->setMissingOptions( $g_lbp_options ); }
?>
<!-- About Lightbox Plus Colorbox for WordPress -->
<div id="poststuff" class="lbp">
	<div class="postbox<?php if ( $g_lbp_options['hide_about'] ) {
		echo ' close-me';
	} ?>">
	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="lightboxplus_multi" id="lightboxplus_multi" value="1"<?php checked( '1', $g_lbp_options['lightboxplus_multi'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="use_inline" id="use_inline" value="1"<?php checked( '1', $g_lbp_options['use_inline'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>">
					<img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
			...
			<td>
				<select name="inline_num" id="inline_num">
					<?php for ( $i = 5; $i <= 50; $i += 5 ) {
						?>
						<option value="<?php echo $i; ?>"<?php selected( $i, $g_lbp_options['inline_num'] ); ?>><?php echo $i; ?></option>
					<?php
					}
					?>
				</select>
		...
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="output_htmlv" id="output_htmlv" value="1"<?php checked( '1', $g_lbp_options['output_htmlv'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr class="htmlv_settings lbp-closed">
			<th scope="row">
				<?php _e( 'HTML Data attribute', 'lightboxplus' ) ?>:
			</th>
			<td>
				data-<input type="text" size="15" name="data_name" id="data_name" value="<?php if ( empty( $g_lbp_options['data_name'] ) ) {
					echo 'lightboxplus';
				} else {
					echo $g_lbp_options['data_name'];
				} ?>" />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="hide_about" id="hide_about" value="1"<?php checked( '1', $g_lbp_options['hide_about'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>">
					<img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
...
<div id="blbp-tabs-2">
	<table class="form-table">
			...
			<td>
				<select name="lightboxplus_style" id="lightboxplus_style">
					...
					foreach ( $styles as $key => $value ) {
						if ( $g_lbp_options['lightboxplus_style'] == urlencode( $key ) ) {
							echo '<option value="' . urlencode( $key ) . '" selected="selected">' . $this->setProperName( $key ) . '</option>'.PHP_EOL;
						} else {
							echo '<option value="' . urlencode( $key ) . '">' . $this->setProperName( $key ) . '</option>'.PHP_EOL;
						}
					}
					?>
				</select>
		...
		<tr>
			<th scope="row">
				<?php _e( 'Use Custom Styles', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="use_custom_style" value="0">
				<input type="checkbox" name="use_custom_style" id="use_custom_style" value="1"<?php checked( '1', $g_lbp_options['use_custom_style'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			<th scope="row">
				<?php _e( 'Disable Lightbox CSS', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="disable_css" value="0">
				<input type="checkbox" name="disable_css" id="disable_css" value="1"<?php checked( '1', $g_lbp_options['disable_css'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
...
<div id="blbp-tabs-3">
	<table class="form-table">
		<tr>
			<th scope="row">
				<?php _e( 'Use page/post options', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="use_perpage" value="0">
				<input type="checkbox" name="use_perpage" id="use_perpage" value="1"<?php checked( '1', $g_lbp_options['use_perpage'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr class="base_blog">
			<th scope="row">
				<?php _e( 'Use for page', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="use_forpage" value="0">
				<input type="checkbox" name="use_forpage" id="use_forpage" value="1"<?php checked( '1', $g_lbp_options['use_forpage'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr class="base_blog">
			<th scope="row">
				<?php _e( 'Use for posts/blog', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="use_forpost" value="0">
				<input type="checkbox" name="use_forpost" id="use_forpost" value="1"<?php checked( '1', $g_lbp_options['use_forpost'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			<th scope="row">
				<?php _e( 'Load in Header/Footer', 'lightboxplus' ) ?>:
			</th>
			<td>
				<select name="load_location" id="load_location">
					<option value="wp_footer"<?php selected( 'wp_footer', $g_lbp_options['load_location'] ); ?>>Footer</option>
					<option value="wp_head"<?php selected( 'wp_head', $g_lbp_options['load_location'] ); ?>>Header</option>
				</select>
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			...
			<td>
				<select name="load_priority" id="load_priority">
					<option value="15"<?php selected( '15', $g_lbp_options['load_priority'] ); ?>>Low</option>
					<option value="10"<?php selected( '10', $g_lbp_options['load_priority'] ); ?>>Normal</option>
					<option value="5"<?php selected( '5', $g_lbp_options['load_priority'] ); ?>>High</option>
				</select>
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
	...
	<table width="100%" border="0" class="lbp-support-info">
		...
		<tr>
			<td width="50%" valign="top">
				...
				<strong>Simple PHP HTML DOM Parser Version:</strong> <?php echo 'LBP_SHD_VERISON'; ?>
			</td>
			<td width="50%" valign="top">
		...
		<tr>
			<td colspan="2" valign="top" id="lbp_detail">
				<?php
				foreach ( $g_lbp_options as $key => $value ) {
					echo '<b>' . $key . ':</b> ' . $value . ' | ';
				}
...
<form name="lightboxplus-settings-primary" name="lightboxplus-settings-primary" method="post" action="<?php echo LBP_ADMIN_PAGE; ?>">
...
<div id="plbp-tabs-1">
	<table class="form-table">
		<tr>
			<th scope="row">
				<?php _e( 'Transition Type', 'lightboxplus' ) ?>:
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<?php _e( 'Resize Speed', 'lightboxplus' ) ?>:
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<?php _e( 'Overlay Opacity', 'lightboxplus' ) ?>:
			</th>
			<td>
				<select name="opacity">
					<?php
		...
		<tr>
			<th scope="row">
				<?php _e( 'Pre-load images', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="preloading" value="0">
				<input type="checkbox" name="preloading" value="1"<?php checked( '1', $g_lbp_primary_options['preloading'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			<th scope="row">
				<?php _e( 'Use For WordPress Galleries', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="gallery_lightboxplus" value="0">
				<input type="checkbox" name="gallery_lightboxplus" id="gallery_lightboxplus" value="1"<?php checked( '1', $g_lbp_primary_options['gallery_lightboxplus'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			<th scope="row">
				<?php _e( 'Separate Galleries in Post?', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="multiple_galleries" value="0">
				<input type="checkbox" name="multiple_galleries" id="multiple_galleries" value="1"<?php checked( '1', $g_lbp_primary_options['multiple_galleries'] ); ?> /><a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
...
<div id="plbp-tabs-2">
	<table class="form-table">
		<tr>
			<th scope="row">
				<?php _e( 'Width', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="text" size="15" name="width" id="width" value="<?php if ( ! empty( $g_lbp_primary_options['width'] ) ) {
		...
		<tr>
			<th scope="row">
				<?php _e( 'Height', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="text" size="15" name="height" id="height" value="<?php if ( ! empty( $g_lbp_primary_options['height'] ) ) {
		...
		<tr>
			<th scope="row">
				<?php _e( 'Inner Width', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="text" size="15" name="inner_width" id="inner_width" value="<?php if ( ! empty( $g_lbp_primary_options['inner_width'] ) ) {
		...
		<tr>
			<th scope="row">
				<?php _e( 'Inner Height', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="text" size="15" name="inner_height" id="inner_height" value="<?php if ( ! empty( $g_lbp_primary_options['inner_height'] ) ) {
		...
		<tr>
			<th scope="row">
				<?php _e( 'Initial Width', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="text" size="15" name="initial_width" id="initial_width" value="<?php if ( ! empty( $g_lbp_primary_options['initial_width'] ) ) {
		...
		<tr>
			<th scope="row">
				<?php _e( 'Initial Height', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="text" size="15" name="initial_height" id="initial_height" value="<?php if ( ! empty( $g_lbp_primary_options['initial_height'] ) ) {
		...
		<tr>
			<th scope="row">
				<?php _e( 'Maximum Width', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="text" size="15" name="max_width" id="max_width" value="<?php if ( ! empty( $g_lbp_primary_options['max_width'] ) ) {
		...
		<tr>
			<th scope="row">
				<?php _e( 'Maximum Height', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="text" size="15" name="max_height" id="max_height" value="<?php if ( ! empty( $g_lbp_primary_options['max_height'] ) ) {
		...
		<tr>
			<th scope="row">
				<?php _e( 'Resize', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="resize" value="0">
				<input type="checkbox" name="resize" id="resize" value="1"<?php checked( '1', $g_lbp_primary_options['resize'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
...
<div id="plbp-tabs-3">
	<table class="form-table">
		<tr>
			...
			<td>
				<input name="top" type="text" id="top" size="8" maxlength="8" value="<?php if ( ! empty( $g_lbp_primary_options['top'] ) ) {
		...
		<tr>
			...
			<td>
				<input name="right" type="text" id="right" size="8" maxlength="8" value="<?php if ( ! empty( $g_lbp_primary_options['right'] ) ) {
		...
		<tr>
			...
			<td>
				<input name="bottom" type="text" id="bottom" size="8" maxlength="8" value="<?php if ( ! empty( $g_lbp_primary_options['bottom'] ) ) {
		...
		<tr>
			...
			<td>
				<input name="left" type="text" id="left" size="8" maxlength="8" value="<?php if ( ! empty( $g_lbp_primary_options['left'] ) ) {
		...
		<tr>
			<th scope="row">
				<?php _e( 'Fixed', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="fixed" value="0">
				<input type="checkbox" name="fixed" id="fixed" value="1"<?php checked( '1', $g_lbp_primary_options['fixed'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
...
<div id="plbp-tabs-4">
	<table class="form-table">
		...
		<tr>
			<th scope="row">
				<?php _e( 'Close image text', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="text" size="15" name="close" id="close" value="<?php if ( empty( $g_lbp_primary_options['close'] ) ) {
					echo '';
				} else {
		...
		<tr>
			<th scope="row">
				<?php _e( 'Overlay Close', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="overlay_close" value="0">
				<input type="checkbox" name="overlay_close" id="overlay_close" value="1"<?php checked( '1', $g_lbp_primary_options['overlay_close'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			<th scope="row">
				<?php _e( 'ESC Key Close', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="esc_key" value="0">
				<input type="checkbox" name="esc_key" id="esc_key" value="1"<?php checked( '1', $g_lbp_primary_options['esc_key'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			<th scope="row">
				<?php _e( 'Scroll Bars', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="scrolling" value="0">
				<input type="checkbox" name="scrolling" id="scrolling" value="1"<?php checked( '1', $g_lbp_primary_options['scrolling'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			<th scope="row">
				<?php _e( 'Disable grouping', 'lightboxplus' ) ?>:
			</th>
			<td>
		...
		<tr class="grouping_prim">
			<th scope="row">
				<?php _e( 'Grouping Labels', 'lightboxplus' ) ?>:
			</th>
			<td>
		...
		<tr class="grouping_prim">
			<th scope="row">
				<?php _e( 'Previous image text', 'lightboxplus' ) ?>:
			</th>
			<td>
		...
		<tr class="grouping_prim">
			<th scope="row">
				<?php _e( 'Next image text', 'lightboxplus' ) ?>:
			</th>
			<td>
		...
		<tr class="grouping_prim">
			<th scope="row">
				<?php _e( 'Arrow key navigation', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="arrow_key" value="0">
				<input type="checkbox" name="arrow_key" id="arrow_key" value="1"<?php checked( '1', $g_lbp_primary_options['arrow_key'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr class="grouping_prim">
			<th scope="row">
				<?php _e( 'Loop image group', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="loop" value="0">
				<input type="checkbox" name="loop" id="loop" value="1"<?php checked( '1', $g_lbp_primary_options['loop'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
...
<div id="plbp-tabs-5">
	<table class="form-table">
		<tr>
			<th scope="row">
				<?php _e( 'Slideshow', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="slideshow" value="0">
				<input type="checkbox" name="slideshow" id="slideshow" value="1"<?php checked( '1', $g_lbp_primary_options['slideshow'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr class="slideshow_prim">
			<th scope="row">
				<?php _e( 'Auto-Start Slideshow', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="slideshow_auto" value="0">
				<input type="checkbox" name="slideshow_auto" id="slideshow_auto" value="1"<?php checked( '1', $g_lbp_primary_options['slideshow_auto'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr class="slideshow_prim">
			<th scope="row">
				<?php _e( 'Slideshow Speed', 'lightboxplus' ) ?>:
			</th>
			<td>
		...
		<tr class="slideshow_prim">
			<th scope="row">
				<?php _e( 'Slideshow start text', 'lightboxplus' ) ?>:
			</th>
			<td>
		...
		<tr class="slideshow_prim">
			<th scope="row">
				<?php _e( 'Slideshow stop text', 'lightboxplus' ) ?>:
			</th>
			<td>
...
<div id="plbp-tabs-6">
	<table class="form-table">
		<tr>
			<th scope="row">
				<?php _e( 'File as photo', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="photo" value="0">
				<input type="checkbox" name="photo" id="photo" value="1"<?php checked( '1', $g_lbp_primary_options['photo'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			<th scope="row">
				<?php _e( 'Use WP Caption for LBP Caption', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="use_caption_title" value="0">
				<input type="checkbox" name="use_caption_title" id="use_caption_title" value="1"<?php checked( '1', $g_lbp_primary_options['use_caption_title'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			<th scope="row">
				<?php _e( 'Use Class Method', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="use_class_method" value="0">
				<input type="checkbox" name="use_class_method" id="use_class_method" value="1"<?php checked( '1', $g_lbp_primary_options['use_class_method'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>">
					<img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr class="primary_class_name lbp-closed">
			<th scope="row">
				<?php _e( 'Class name', 'lightboxplus' ) ?>:
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<?php _e( 'Auto-Lightbox Text Links', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="text_links" value="0">
				<input type="checkbox" name="text_links" id="text_links" value="1"<?php checked( '1', $g_lbp_primary_options['text_links'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			<th scope="row">
				<?php _e( '<strong>Do Not</strong> Auto-Lightbox Images', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="no_auto_lightbox" value="0">
				<input type="checkbox" name="no_auto_lightbox" id="no_auto_lightbox" value="1"<?php checked( '1', $g_lbp_primary_options['no_auto_lightbox'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
		...
		<tr>
			<th scope="row">
				<?php _e( '<strong>Do Not</strong> Display Image Title', 'lightboxplus' ) ?>:
			</th>
			<td>
				<input type="hidden" name="no_display_title" value="0">
				<input type="checkbox" name="no_display_title" id="no_display_title" value="1"<?php checked( '1', $g_lbp_primary_options['no_display_title'] ); ?> />
				<a class="lbp-info" title="<?php _e( 'Click for Help!', 'lightboxplus' ) ?>"><img src="<?php echo LBP_ASSETS_URL . '/images/help.png' ?>" alt="<?php _e( 'Click for Help!', 'lightboxplus' ); ?>" /></a>
...
<?php
if ( $g_lbp_options['lightboxplus_multi'] ) {
	require( LBP_CLASS_PATH . '/lightbox.secondary.php' );
}
if ( $g_lbp_options['use_inline'] ) {
	require( LBP_CLASS_PATH . '/lightbox.inline.php' );
}
?>
</div>

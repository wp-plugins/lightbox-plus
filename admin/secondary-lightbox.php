							...
							<table class="form-table">
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_transition_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_transition_sec_tip">
											<?php _e( 'Specifies the transition type. Can be set to "elastic", "fade", or "none".<br /><strong><em>Default: Elastic</em></strong>', 'lightboxplus' )?>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_speed_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_speed_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_width_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_width_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_height_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_height_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<div class="lbp-tip" id="lbp_inner_width_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_inner_height_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_inner_height_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_initial_width_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_initial_width_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_initial_height_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_initial_height_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_max_width_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_max_width_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_max_height_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_max_height_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_resize_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_resize_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_opacity_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_opacity_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_preloading_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_preloading_sec_tip">
								...
								<tr>
									...
									<td>
										...
										# <a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_label_image_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_label_image_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_previous_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_previous_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_next_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_next_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_close_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_close_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_overlay_close_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_overlay_close_sec_tip">
							...
							<table class="form-table">
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_slideshow_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_slideshow_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_slideshow_auto_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_slideshow_auto_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_slideshow_speed_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_slideshow_speed_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_slideshow_start_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_slideshow_start_sec_tip">
								...
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_slideshow_stop_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_slideshow_stop_sec_tip">
							...
							<table class="form-table">
								<tr>
									...
									<td>
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_iframe_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_iframe_sec_tip">
											<?php _e( 'If checked, specifies that content should be displayed in an iFrame. Must be used when using Lightbox Plus to display content from another site.  Can be used to display external web pages, video and more.<br /><strong><em>Default: Unchecked</em></strong>', 'lightboxplus' )?>
										</div>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="checkbox" name="class_method_sec" id="class_method_sec" value="1"<?php if ( $lightboxPlusOptions['class_method_sec'] ) echo ' checked="checked"';?> />
										Class name:
										...
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_class_method_sec_tip');"> <img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_class_method_sec_tip">
								...
								<tr>
									...
									<td>
										<input type="checkbox" name="display_title_sec" id="display_title_sec" value="1"<?php if ( $lightboxPlusOptions['display_title_sec'] ) echo ' checked="checked"';?> />
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>" onclick="toggleVisibility('lbp_display_title_sec_tip');"><img src="<?php echo $g_lightbox_plus_url.'/admin/information.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
										<div class="lbp-tip" id="lbp_display_title_sec_tip">

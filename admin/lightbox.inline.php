						...
						<tbody>
							<?php
								for ($i = 1; $i <= $lightboxPlusOptions['inline_num']; $i++) {
									...
									$inline_position_fixeds  = $lightboxPlusOptions['inline_position_fixeds'];
								...
								<tr <?php if ($i % 2 == 0) {echo 'class="alternate"';} ?>>
									...
									<td align="center">
										<input type="text" size="8" name="inline_width_<?php echo $i; ?>" id="inline_width_<?php echo $i; ?>" value="<?php if (empty( $inline_widths[$i - 1] )) { echo '80%'; } else {echo $inline_widths[$i - 1];}?>" /><br />
										<input type="text" size="8" name="inline_height_<?php echo $i; ?>" id="inline_height_<?php echo $i; ?>" value="<?php if (empty( $inline_heights[$i - 1] )) { echo '80%'; } else  {echo $inline_heights[$i - 1];}?>" />
									</td>
									<td align="center">
										<input type="text" size="8" name="inline_inner_width_<?php echo $i; ?>" id="inline_inner_width_<?php echo $i; ?>" value="<?php if (empty( $inline_inner_widths[$i - 1] )) { echo 'false'; } else {echo $inline_inner_widths[$i - 1];}?>" /><br />
										<input type="text" size="8" name="inline_inner_height_<?php echo $i; ?>" id="inline_inner_height_<?php echo $i; ?>" value="<?php if (empty( $inline_inner_heights[$i - 1] )) { echo 'false'; } else {echo $inline_inner_heights[$i - 1];}?>" />
									</td>
									<td align="center">
										<input type="text" size="8" name="inline_max_width_<?php echo $i; ?>" id="inline_max_width_<?php echo $i; ?>" value="<?php if (empty( $inline_max_widths[$i - 1] )) { echo '80%'; } else {echo $inline_max_widths[$i - 1];}?>" /><br />
										<input type="text" size="8" name="inline_max_height_<?php echo $i; ?>" id="inline_max_height_<?php echo $i; ?>" value="<?php if (empty( $inline_max_heights[$i - 1] )) { echo '80%'; } else  {echo $inline_max_heights[$i - 1];}?>" />
									</td>
									<td align="center">
										<input type="text" size="8" name="inline_position_top_<?php echo $i; ?>" id="inline_position_top_<?php echo $i; ?>" value="<?php if (empty( $inline_position_tops[$i - 1] )) { echo ''; } else {echo $inline_position_tops[$i - 1];}?>" /><br />
										<input type="text" size="8" name="inline_position_right_<?php echo $i; ?>" id="inline_position_right_<?php echo $i; ?>" value="<?php if (empty( $inline_position_rights[$i - 1] )) { echo ''; } else {echo $inline_position_rights[$i - 1];}?>" /><input type="text" size="8" name="inline_position_bottom_<?php echo $i; ?>" id="inline_position_bottom_<?php echo $i; ?>" value="<?php if (empty( $inline_position_bottoms[$i - 1] )) { echo ''; } else {echo $inline_position_bottoms[$i - 1];}?>" /><br />
										<input type="text" size="8" name="inline_position_left_<?php echo $i; ?>" id="inline_position_left_<?php echo $i; ?>" value="<?php if (empty( $inline_position_lefts[$i - 1] )) { echo ''; } else {echo $inline_position_lefts[$i - 1];}?>" />
									</td>
									<td align="center">
										<input type="checkbox" name="inline_fixed_<?php echo $i; ?>" id="inline_fixed_<?php echo $i; ?>" value="1"<?php if ( ($inline_position_fixeds[$i - 1] )) { echo ' checked="checked"'; }?> />
									</td>
									<td align="center">
										<input type="text" size="8" name="inline_opacity_<?php echo $i; ?>" id="inline_opacity_<?php echo $i; ?>" value="<?php if (empty( $inline_opacitys[$i - 1] )) { echo '80%'; } else {echo $inline_opacitys[$i - 1];}?>" />
									</td>
								</tr>
								<?php
								}

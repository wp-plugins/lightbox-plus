			...
			<div class="inside toggle">
				<div id="blbp-tabs">
					...
					<div id="blbp-tabs-1" title="General">
						<table class="form-table" title="Styles">
							<tr valign="top">
								<th scope="row">
					...
					<!-- Styles -->
					<div id="blbp-tabs-2" title="Styles">
						<table class="form-table" title="Styles">
							<tr valign="top">
								<th scope="row">
					...
					<!-- Advanced -->
					<div id="blbp-tabs-3" title="Advanced">
						<table class="form-table" title="Advanced">
							<tr>
								<th scope="row">
	...
	<div id="poststuff" class="lbp">
		<div class="postbox">
			...
			<div class="inside toggle">
					<div id="plbp-tabs">
						<ul>
							<li><a href="#plbp-tabs-1"><?php _e( 'Transition','lightboxplus' ); ?></a></li>
						...
						<!-- Transition -->
						<div id="plbp-tabs-1" title="Transition">
							<table class="form-table" title="Transition">
								<tr>
									<th scope="row">
						...
						<!-- Position -->
						<div id="plbp-tabs-3" title="Position">
							<table class="form-table">
								<tr>
						...
						<!-- Interface -->
						<div id="plbp-tabs-4" title="Interface">
							<table class="form-table">
								<tr>
									<th scope="row">
								...
								<tr>
									...
									<td>
										<input type="checkbox" name="nogrouping" value="1"<?php if ( $lightboxPlusOptions['nogrouping'] ) echo ' checked="checked"';?> />
										<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>"><img src="<?php echo $g_lightbox_plus_url.'/admin/images/help.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
						...
						<!-- Slideshow -->
						<div id="plbp-tabs-5" title="Slideshow">
							<table class="form-table">
								<tr>
									<th scope="row">
						...
						<!-- Other -->
						<div id="plbp-tabs-6" title="Other">
							<table class="form-table">
								<tr>
									<th scope="row">
						...
						<!-- Usage -->
						<div id="plbp-tabs-7" title="Usage">
						...
						<!-- Demo/Test -->
						<div id="plbp-tabs-8" title="Demo/Test">  
...
<div class="ui-widget">
	<div class="ui-state-highlight ui-corner-all" style="margin-top: 20px; padding: 0 .7em;"> 
		<p>
			...
			<h4><big><?php _e( 'Reset/Re-initialize Lightbox Plus','lightboxplus' ); ?></big></h4>
		</p>
		<form action="<?php echo $location?>&amp;updated=reset" method="post" id="lightboxplus_reset" name="lightboxplus_reset">
			<p><?php _e( 'This will immediately remove all existing settings and any files for versions of Lightbox Plus prior to version 1.5 (if needed) and will also re-initialize the plugin with the new default options. Be absolutely certain you want to do this. <br /><br /><strong><em>If you are upgrading from a version prior to 1.4 it is <strong><em>highly</em></strong> recommended that you reinitialize Lightbox Plus</em></strong>','lightboxplus' ); ?></p>
			<input type="hidden" name="action" value="action" />

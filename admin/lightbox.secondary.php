...
<div id="poststuff" class="lbp">
	<div class="postbox close-me">
		...
		<div class="inside toggle">
			...
			<div id="slbp-tabs">
				<ul>
					<li><a href="#slbp-tabs-1"><?php _e( 'Transition','lightboxplus' ); ?></a></li>
				...
				<!-- Transition -->
				<div id="slbp-tabs-1" title="Transition">
				...
				<div id="slbp-tabs-4" title="Interface">
					<table class="form-table" title="Interface">
						...
						<tr>
							...
							<td>
								<input type="checkbox" name="nogrouping_sec" value="1"<?php if ( $lightboxPlusOptions['nogrouping_sec'] ) echo ' checked="checked"';?> />
								<a class="lbp-info" title="<?php _e('Click for Help!', 'lightboxplus')?>"><img src="<?php echo $g_lightbox_plus_url.'/admin/images/help.png'?>" alt="<?php _e('Click for Help!', 'lightboxplus'); ?>" /></a>
